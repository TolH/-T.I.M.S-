...
//==================================// 
	//HELI_PARADROP CONFIGS
		HELI_PARADROP		= 1;			// DROP 3 WAVES OF AI GROUP BY HELICOPTER ON A RANDOM PLAYER IF THE RADIOTOWER IS TAKEN BY AI. (Default 1=Enabled)
			...
			HP_WAVE_2	= [120, 6, 0.50];	// [TIME2,AINUMBER,SKILLS] SET WAVE_2 SETTINGS. Default=10MINS+6(AI)  [600, 6, 0.15]
			HP_WAVE_3	= [180, 7, 1.00];	// [TIME3,AINUMBER,SKILLS] SET WAVE_3 SETTINGS. Default=15MINS+7(AI)  [900, 7, 0.20]
//==================================//  
