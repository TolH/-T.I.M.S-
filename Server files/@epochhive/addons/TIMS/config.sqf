...
//==================================// 
	//SPECIFIC MISSION CONFIG
		...
		//-----------------------------//
			...
			TOWER_CAPTURE_TIME_AI	= 300;			// THE TIME NEEDED FOR AI TO CAPTURE A MISSION OBJECTIVE. (Default 900=15MINUTES)
			TOWER_CAPTURE_TIME_PL	= 300;			// THE TIME NEEDED FOR PLAYERS TO CAPTURE A MISSION OBJECTIVE FOR BONUS +MP. (Default 900=15MINUTES)
