...
//==================================// 
	//HELI_PARADROP CONFIGS
		HELI_PARADROP		= 1;			// DROP AN AI GROUP BY HELICOPTER ON A RANDOM PLAYER IF THE RADIOTOWER IS ALIVE. (Default 1=Enabled)
			//ADDITIONAL PARADROP AI CONFIG
			// !!!NOT YET WORKING!!!
			HP_WAVE_1	= [300, 5, 0.10];	// [TIME1,AINUMBER,SKILLS] SET WAVE_1 SETTINGS. Default=5MINS+5(AI)   [300, 5, 0.10]
			HP_WAVE_2	= [600, 6, 0.15];	// [TIME2,AINUMBER,SKILLS] SET WAVE_2 SETTINGS. Default=10MINS+6(AI)  [600, 6, 0.15]
			HP_WAVE_3	= [900, 7, 0.20];	// [TIME3,AINUMBER,SKILLS] SET WAVE_3 SETTINGS. Default=15MINS+7(AI)  [900, 7, 0.20]
//==================================//  
