		...
		while {HeliTimer1 isEqualTo 1} do 
		{
			...
			while {_countHP1 < 900} do 
			{
			  ...
			  uiSleep 1;
				...
				{
					//[LVgroup8] HP_WAVE2
					_LVgroup8 = [player,3,true,true,1500,"random",true,200,150,6,0.6,75,true,true,false,false,player,false,0.1,nil,nil,8,true,false,["TOHL_HARD"]] execVM "TIMS\LV\heliParadrop.sqf";
				...
				{
					//[LVgroup9] HP_WAVE3
					_LVgroup9 = [player,3,true,true,1500,"random",true,200,150,7,0.6,75,true,true,false,false,player,false,0.1,nil,nil,9,true,false,["TOHL_HARD"]] execVM "TIMS\LV\heliParadrop.sqf";
