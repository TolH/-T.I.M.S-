//============================================////============================================//
	class ZOMBIE_MISSION_START_NOTIFICATION
	{
		idd = -1;
		duration = 15;
		fadeIn = 1;
		...
		class controls
		{
			class MyRscStructuredText
			{
				...
				size = 0.03;
				sizeEx = 0.03;
				text = "	                      <t size='1' color='#10b9c1'>Mission: -=ZOMBRELLA_CORP=-</t><br />	                      Something here...<br />	                      Something else here...<br />	                      DIFFICULTY: (HARD)";
				class Attributes
				{
					font = "PuristaMedium";
					color = "#ffffff";
