...
disableSerialization;
	...
	[] spawn 
	{
		...
		_colourCrypto	= parseText "#66cc00";
		_ZombieColor	= parseText "#1a990a";
	...
	while {true} do 
	{
		...
		//_playersNearby = count (player nearEntities ['Man',800])-1;
		//_AiCount = resistance countSide allunits;
		//_ZombieCount = WEST countSide allunits;
	...
	//display the information 
		((uiNamespace getVariable "statusBar")displayCtrl 55555)ctrlSetStructuredText parseText 
			format["
			<t shadow='1' shadowColor='#000000' color='%9'><img size='1.6'  shadowColor='#000000' image='addons\status_bar\images\players.paa' color='%9'/> %2</t>
			<t shadow='1' shadowColor='#000000' color='%10'><img size='1.6'  shadowColor='#000000' image='addons\status_bar\images\damage.paa' color='%10'/>%3%1</t> 
			<t shadow='1' shadowColor='#000000' color='%16'><img size='1.6'  shadowColor='#000000' image='addons\status_bar\images\krypto.paa' color='%16'/> %4</t> 
			<t shadow='1' shadowColor='#000000' color='%11'><img size='1.6'  shadowColor='#000000' image='addons\status_bar\images\hunger.paa' color='%11'/>%5%1</t> 
			<t shadow='1' shadowColor='#000000' color='%12'><img size='1.6'  shadowColor='#000000' image='addons\status_bar\images\thirst.paa' color='%12'/>%6%1</t> 
			<t shadow='1' shadowColor='#000000' color='%13'><img size='1.6'  shadowColor='#000000' image='addons\status_bar\images\energy.paa' color='%13'/>%8%1</t>",
			//<t shadow='1' shadowColor='#000000' color='%9'><img size='1.6'  shadowColor='#000000' image='addons\status_bar\images\players.paa' color='%9'/> %17</t>
			//<t shadow='1' shadowColor='#000000' color='%9'>FPS: %7</t>",
					...
					_hours, // #14
					_minutes, // #15
					_colourCrypto // #16 Yellow for Crypto
					//_playersNearby // #17
				];
	}; 
};