class config_aissp
{
	...
	class classPresets
	{
		...
		class TOHL_HARD
		{
			...
			menSF[] = {"I_Sniper_F","I_Spotter_F","I_support_MG_F","I_medic_F","I_Soldier_SL_F","I_Soldier_TL_F","I_Soldier_M_F","I_Soldier_repair_F"};
			divers[] = {"I_diver_F","I_diver_exp_F","I_diver_TL_F"};
			cars[] = {"I_G_Offroad_01_armed_F","I_MRAP_03_F","I_MRAP_03_hmg_F","I_MRAP_03_gmg_F","I_APC_Wheeled_03_cannon_F","I_UGV_01_F","I_UGV_01_rcws_F"};
